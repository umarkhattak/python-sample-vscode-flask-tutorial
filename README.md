[![Build Status](https://dev.azure.com/PeterUmarVim/ClassOfOct22/_apis/build/status/umarkhattak.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/PeterUmarVim/ClassOfOct22/_build/latest?definitionId=1&branchName=master)
